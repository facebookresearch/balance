...
/* harmony import */ var _chunk_BSJP7CBP_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11334);
/* harmony import */ var _chunk_ZZ45TVLE_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(97963);
/* harmony import */ var _chunk_U2HBQHQK_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(35183);
/* harmony import */ var _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(28718);
/* harmony import */ var _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(17726);
...
var BG_FILL = "bgFill";
var STYLECLASS_SEP = ",";
var config = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)();
var classes = /* @__PURE__ */ new Map();
var diagramId = "";
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((txt) => _chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default */ .Y2.sanitizeText(txt, config), "sanitizeText");
...
var clear2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(() => {
  ...
  (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .clear */ .IU)();
...
var setDiagramId = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((id) => {
  diagramId = id;
}, "setDiagramId");
var getDiagramId = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(() => diagramId, "getDiagramId");
...
var db = {
  getConfig: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(() => (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)().block, "getConfig"),
  typeStr2Type,
  edgeTypeStr2Type,
  edgeStrToEdgeData,
  getLogger,
...
var padding = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)()?.block?.padding ?? 8;
...
var createLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (element, _vertexText, style, isTitle = false, isNode = false) => {
  ...
  const config2 = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)();
  const useHtmlLabels = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getEffectiveHtmlLabels */ .E)(config2);
  return await (0,_chunk_U2HBQHQK_mjs__WEBPACK_IMPORTED_MODULE_3__/* .createText */ .GZ)(
    element,
    vertexText,
    {
      style,
...
var insertEdgeLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (elem, edge) => {
  ...
  const labelElement = await (0,_chunk_U2HBQHQK_mjs__WEBPACK_IMPORTED_MODULE_3__/* .createText */ .GZ)(
    elem,
    edge.label,
    {
  ...
  label.attr("transform", (0,_chunk_BSJP7CBP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .computeLabelTransform */ .Wg)(transformBbox, useHtmlLabels));
  ...
  if (edge.startLabelLeft) {
    ...
    inner.attr("transform", (0,_chunk_BSJP7CBP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .computeLabelTransform */ .Wg)(slBox, useHtmlLabels));
...
function setTerminalWidth(fo, value) {
  if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getEffectiveHtmlLabels */ .E)((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)()) && fo) {
...
var positionEdgeLabel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((edge, paths) => {
  ...
  const siteConfig = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)();
  const { subGraphTitleTotalMargin } = (0,_chunk_ZZ45TVLE_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getSubGraphTitleMargins */ .O)(siteConfig);
  if (edge.label) {
    const el = edgeLabels[edge.id];
    let x = edge.x;
    let y = edge.y;
    if (path) {
      const pos = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ ._K.calcLabelPosition(path);
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug(
  ...
  if (edge.startLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
      x = pos.x;
      y = pos.y;
    }
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ ._K.calcTerminalLabelPosition(
  ...
  if (edge.endLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
  ...
  if (edge.endLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
...
var insertEdge = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(elem, e, edge, clusterDb, diagramType, graph, id) {
  ...
  const { x, y } = (0,_chunk_BSJP7CBP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getLineFunctionsWithOffset */ .RI)(edge);
  ...
  let url = "";
  if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)().flowchart.arrowMarkerAbsolute || (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)().state.arrowMarkerAbsolute) {
    url = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getUrl */ .ID)(true);
  }
...
var labelHelper = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (parent, node, _classes, isNode) => {
  const config2 = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)();
  let classes2;
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getEffectiveHtmlLabels */ .E)(config2);
  if (!_classes) {
  ...
  if (node.labelType === "markdown") {
    text = (0,_chunk_U2HBQHQK_mjs__WEBPACK_IMPORTED_MODULE_3__/* .createText */ .GZ)(
      label,
      (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .sanitizeText */ .jZ)((0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .decodeEntities */ .Sm)(labelText), config2),
      {
        useHtmlLabels,
  ...
  if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getEffectiveHtmlLabels */ .E)(config2)) {
    const div = text.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_10__/* .select */ .Ltv)(text);
    await (0,_chunk_ZZ45TVLE_mjs__WEBPACK_IMPORTED_MODULE_2__/* .configureLabelImages */ .X)(div, labelText);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
    dv.attr("height", bbox.height);
  }
...
var note = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (parent, node) => {
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getEffectiveHtmlLabels */ .E)((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)());
  if (!useHtmlLabels) {
...
var rectWithTitle = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (parent, node) => {
  ...
  if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getEffectiveHtmlLabels */ .E)((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)())) {
    const div = text.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_10__/* .select */ .Ltv)(text);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
...
var insertNode = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (elem, node, renderOptions) => {
  ...
  if (node.link) {
    let target;
    if ((0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)().securityLevel === "sandbox") {
      target = "_top";
...
function getNodeFromBlock(block, db2, positioned = false) {
  ...
  const styles = (0,_chunk_5PVQY5BW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getStylesFromArray */ .sM)(vertex?.styles ?? []);
  ...
  const node = {
    ...
    intersect: void 0,
    type: vertex.type,
    padding: padding2 ?? (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)()?.block?.padding ?? 0
  };
  return node;
}
...
async function calculateBlockSize(elem, block, db2) {
  ...
  const config2 = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async function(text, id, _version, diagObj) {
  const { securityLevel, block: conf } = (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)();
  ...
  if (bounds) {
    ...
    (0,_chunk_ICPOFSXX_mjs__WEBPACK_IMPORTED_MODULE_5__/* .configureSvgSize */ .a$)(svg, height, width, !!useMaxWidth);
