...
**Requirements**: You will need a [Jupyter installation](https://jupyter.org/) to run these notebooks yourselves. We also assume you have the [balance pkg](/docs/docs/getting-started) installed.
