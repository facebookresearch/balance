...
See ``~/balance_diff_diff/SVY_FUTURE_PROOFING.md`` §2 for the policy
context.
"""

from __future__ import annotations

#: Canonical name of the active weight column on a balance ``Sample``
#: post-``adjust()`` (preserved by ``balance_frame.py:820-822``).
