...
3. [**balance_transformations_and_formulas**](./balance_transformations_and_formulas) - This tutorial showcases ways in which transformations, formulas and panelty can be included in your pre-processing of the coveriates before adjusting for them.
